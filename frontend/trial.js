      ...
      <div class="cid-flow-legend">
        <details class="cid-flow-help">
          ...
          <div class="cid-flow-help-body">
            ...
            ${showRunLineage ? `<p><strong>Run lineage</strong> (overlay on): <span style="color:#fd7e14;font-weight:bold">╌╌▶</span> dashed orange edge = <code>parent_rid</code> link (run → its parent run); each <code>llm_request</code> node's label gains its <code>rid</code>; a <span style="color:#dc3545;font-weight:bold">red dashed border</span> marks a run whose carriers disagreed on the parent (<code>parent_rid_anomaly</code>).</p>` : ""}
          </div>
        </details>
      </div>
    </div>
