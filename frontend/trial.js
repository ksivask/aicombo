        ...
        <details class="cid-flow-help">
          ...
          <div class="cid-flow-help-body">
            ...
            <ul>
              ...
              <li><span style="color:#dc3545;font-weight:bold">╌▶|run|</span> <strong>run-lineage</strong> — dashed <code>|run|</code> edge = <code>parent_rid</code> link (run → its parent run).</li>
              <li><span style="color:#dc3545;font-weight:bold">╌▶|calls|</span> <strong>run-lineage</strong> — dashed <code>|calls|</code> edge = <code>parent_run_rid</code>: the run that ORIGINATED this <code>tool_call</code>/<code>tool_response</code> (primary MCP-call↔run link).</li>
